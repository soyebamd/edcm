...
<html lang="en">
  <!-- Mirrored from www.elvisdirtcheapmovingandstorage.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Jun 2024 04:12:59 GMT -->
  <head>
    <title>Moving and Storage | Philadelphia, PA</title>
    ...
    <meta
      name="DESCRIPTION"
      content="Elvis Dirt Cheap Moving and Storage provides moving and storage services to residents and businesses. Call today for hassle and stress free moving."
    />
    <meta
      name="KEYWORDS"
      content="moving and storage, philadelphia, pennsylvania, pa
"
    />
    <script
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        if (
          ...
          $("#CTCPhoneNumber").wrapInner(
            '<a href="" style="text-decoration:none !important; color: inherit !important;"></a>'
          );
          $("#CTCPhoneNumber")
            .find("a")
            .attr("href", "tel:" + ttdPhoneNumber);
        }
        ...
        if (window.location.href.indexOf("SecureCart") > -1) {
          $(
            ".mtrx_ecom_layout > table > tbody > tr:first-child , .mtrx_ecom_layout > table > tbody > tr:nth-child(2) > td:first-child"
          ).css("display", "none");
        }
        ...
        !(function (e, t) {
          ...
          return (
            (d.render = function () {
              for (
                var e = document.querySelectorAll(d.selector.join()),
                  t = e.length;
                t--;
        ...
        $(
          ".responsiveTable tr:first, .responsiveTable thead tr:first"
        ).addClass("tableHeader");
        $(
          ".responsiveTable tr:first td, .responsiveTable thead tr:first th"
        ).addClass("colHeader");
      ...
      $(window).on("load resize", function (e) {
        ...
        if (toowide == "yes") {
          $("#navContainer .primary-webcomMenu").append(
            "<li id='slideout-menu-toggle' class='hamburger'><a href='#' id='nav-toggle' ><span></span><div></div></a></li>"
          );
        }
    ...
    <style id="_app_designed_custom_css" type="text/css">
      /*Button*/
      .button {
        background: #42a5f5;
        color: #ffffff;
      ...
      .black-outline {
        text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000,
          1px 1px 0 #000, 2px 2px 2px rgba(255, 255, 255, 0.5);
      }
      .white-outline {
        text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff,
          1px 1px 0 #fff, 2px 2px 2px rgba(0, 0, 0, 0.5);
      }
      .grey-outline-15px {
        outline: 15px solid;
        outline-offset: -15px;
    ...
    <style id="_template_custom_css" type="text/css">
      ...
      .primaryColorbg .hamburger span,
      .primaryColorbg .hamburger span:before,
      .primaryColorbg .hamburger span:after {
      ...
      .buttonGhost.buttonInverted,
      a.buttonInverted.buttonGhost,
      .buttonInverted.buttonGhost a {
        border-color: #ffffff;
        color: #ffffff;
      }
      ...
      li.primary-webcomMenuItem > a:hover:before,
      ...
      h5.header {
        ...
        float: left;
        color: #fff;
        text-shadow: 2px 2px #000, 4px 4px 5px rgba(0, 0, 0, 0.7);
      }
      ...
      .hp-button img:hover {
        -ms-transform: rotate(2deg) scale(1.2, 1.2); /* IE 9 */
        -webkit-transform: rotate(2deg) scale(1.2, 1.2); /* Safari */
    ...
    <script
      ...
      src="scripts/browserBehavior.js"
    ></script>
    ...
    <link
      rel="StyleSheet"
      type="text/css"
      href="assets/uaDefaultStylesReset.css"
    />
    ...
    <script type="text/javascript">
      ...
      WebCom.ResourceLoader.loadLib(
        "com.web.components.footercontact",
        "1.0",
        true
      );
    </script>
          ...
          WebCom.Components.SocialMediaShare.initInstances([
            {
              miscData: {
                renderMode: "Publish",
                q: "JhBFnjDhIwnYuDeRvByGafNnGZ3CbaAn+uZ51u/qi/GPZdWlM7ZFIedC+fdfyrwRH9CtG7AlSeTe\r\nfIkeENDoop134jax110824zZm2pyM432zrhKDIw4/y1n1HXv30Jb+ebCxo4S90IdEnAqm1lXbz/D\r\nX0JgQYj7cZDsG5XeOYGNn0aVpXLXpQ==",
              },
        ...
        WebCom.Components.Form.renderInstances([
          {
            miscData: {
              renderMode: "Publish",
              q: "\r\n7D9FlD5Qjw/sVJEK1xVLg483Vub5IGaYPbUx6u+K",
            },
            componentData: {
              form: {
                template: "ContactUs",
            ...
            id: "webcom-component-form-37609665821270462",
          },
        ]);
      });
      // -->
      ...
      <div class="header clearfix">
        <div id="companyname">
          <div>
            <style>
              <!--
              .Header-LogoLeft-PhoneRight .phone {float: right}
              				.Header-LogoLeft-PhoneRight .phone td {vertical-align: center}
              				.Header-LogoLeft-PhoneRight .phone img {display: block; margin: 0 5px 0 0}
              				.Header-LogoLeft-PhoneRight .phone {
              					display: inline-block;
              					text-align: right;
              					vertical-align: middle;
            ...
            <table
              ...
              width="100%"
              class="fullwidth"
              style="background-image: url(files/121682124.jpg)"
              cellpadding="0"
            >
              <tbody>
                <tr>
                            ...
                            <td>
                              <a href="index.php" target="_self"
                                ><img
                                  ...
                                  title="EDCM"
                                  assetid="123428009"
                                  src="image/123428009.png"
                                  height="79"
                                  border="0"
                                  alt="EDCM"
                                  selectedfileurl="files/123428009.png"
                                  mce_src="/matrix/servlet/ShowAsset;jsessionid=DBDD63A9EC77A3F1687B8C465F2401FF?id=123428009&_dt=1494591982721"
                              /></a>
                            </td>
                                    ...
                                    <tr>
                                      <td>
                                        <img
                                          ...
                                          title="Phone Icon"
                                          assetid="121682125"
                                          src="image/121682125.png"
                                          height="23"
                                          border="0"
                                          alt="Phone Icon"
                                          selectedfileurl="files/121682125.png"
                                          mce_src="/matrix/servlet/ShowAsset;jsessionid=1B36598A706C2FC3FDF8D2C72FF6EC36?id=121682125&_dt=1487022870748"
                                        />
                                      </td>
                                      <td>
                                        <p>
                                ...
                                ><strong
                                  ><span
                                    style="
                                      ...
                                      text-decoration: none;
                                    "
                                    >Philadelphia, PA 19144-3020</span
                                  ></strong
                                >
                              </p>
                              <p>
